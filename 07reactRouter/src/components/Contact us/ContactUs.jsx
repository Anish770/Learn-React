...
function ContactUs() {
  return (
    <div className='relative flex items-center justify-center  min-h-[700px] sm:items-center sm:pt-0 '>
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8   flex justify-center">
            <div className="mt-8 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2  ">
                    <div className="p-6 mr-2 bg-gray-200 sm:rounded-lg  ">
                        <h1 className="text-3xl mb-7 sm:text-4xl text-gray-800 font-extrabold tracking-tight"
                        ...
                        <div className="flex items-center mt-4 text-gray-600">
                         <svg
                                ...
                                <div className="ml-4 text-md tracking-wide font-semibold w-40  ">+919064736591</div>
                        </div>
                        <div className="flex items-center mt-4 text-gray-600">
                        <svg
                                    fill="none"
                                ...
                                <div className="ml-4 text-md tracking-wide font-semibold w-40  ">info@zenCafe.org</div>
                        </div>
                    </div>
                    <form action="p-6 flex flex-col justify-center  ">
