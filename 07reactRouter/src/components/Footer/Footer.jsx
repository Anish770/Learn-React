    ...
    <footer className='bg-white border-y'>
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 " >
          ...
          <div className=" grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3  ">
            <div className=''>
              ...
              <ul className='text-gray-500 font-medium'>
                ...
                Home</NavLink></li>
                <li className='mb-4'><NavLink to='about' className={({isActive})=>`hover:underline ${isActive?"text-orange-500":"text-gray-700"}`}>
                About</NavLink></li>
              </ul>
            </div>
            <div className=''>
        ...
        <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
          ...
          <svg className="w-4 h-4 hover:text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
              <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
           </svg>
           <span className='sr-only'>Facebook page</span>
          </Link>
          <Link to="#" className="text-gray-500">
            <svg className="w-4 h-4 hover:text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"viewBox="0 0 21 16">
          ...
          <Link to="#" className="text-gray-500">
            <svg className="w-4 h-4 hover:text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
                                <path
                                    fill-rule="evenodd"
